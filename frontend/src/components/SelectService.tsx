          ...
          >
            <div className="p-4 sm:p-5 flex flex-col flex-1">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h2 className="text-lg sm:text-xl font-semibold text-blue-900 font-sans tracking-wide">
                  {service.name}
                </h2>
              </div>
              ...
              <Link
                ...
                className="mt-auto w-full text-center bg-blue-600 text-white py-2 sm:py-2.5 px-4 rounded-lg hover:bg-blue-700 transition-colors duration-200 font-medium text-sm sm:text-base"
              >
                Seleccionar
              </Link>
            </div>
