        ...
        <header className="bg-white border-b border-gray-200 shadow-sm">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Ds Barberstudio</h1>
            </div>
            <nav className="space-x-6 hidden sm:flex">
              ...
              <Link href="/contacto" className="text-gray-600 hover:text-blue-700 transition-colors duration-200">
                Contacto
              </Link>
            </nav>
            <button className="sm:hidden text-gray-600 hover:text-blue-700 transition-colors duration-200">
        ...
        <footer className="bg-white border-t border-gray-200 mt-8">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row justify-between items-center">
            ...
            <div className="flex gap-4">
              <Link href="https://www.instagram.com" target="_blank" className="text-gray-600 hover:text-blue-700 transition-colors duration-200">
              ...
              <Link href="https://www.whatsapp.com" target="_blank" className="text-gray-600 hover:text-blue-700 transition-colors duration-200">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
