...
export default function SeleccionarBarbero() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 flex flex-col items-center py-16">
      <div className="w-full max-w-5xl mx-auto bg-white rounded-3xl shadow-xl p-10 border border-gray-200">
