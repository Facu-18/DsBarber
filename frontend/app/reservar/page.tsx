...
export default function ElegirServicio() {
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col items-center py-6 sm:py-8 md:py-12">
            {/* Contenedor principal */}
            <div className="w-full max-w-7xl mx-auto bg-white rounded-3xl shadow-xl p-4 sm:p-6 md:p-8">
                ...
                <div className="flex flex-col md:flex-row gap-4 sm:gap-6 md:gap-8 mb-6 sm:mb-8">
                    ...
                    <div className="flex-1">
                        <div className="flex items-center gap-3 sm:gap-4 mb-4">
                            {/* Logo */}
                            <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-full overflow-hidden flex items-center justify-center">
                                <Image src="/DS_Barbershop_Logo.svg" alt="Logo" width={150} height={60} priority />
                            </div>
                            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">Ds Barberstudio</h1>
                        </div>
                    ...
                    <div className="flex-1">
                        <div className="bg-gray-50 rounded-xl p-3 sm:p-4 md:p-6 border border-gray-100 shadow-sm">
                            <Map />
                            <Link
                                ...
                                className="text-xs sm:text-sm text-gray-600 hover:text-blue-700 transition-colors duration-200 block mb-2"
                            >
                                Bartolomé Hidalgo 1669, Córdoba Parque Liceo III
                            </Link>
                            <p className="text-xs sm:text-sm text-blue-600">+54 9 3512291106</p>
                            <div className="mt-3 sm:mt-4">
                                <span className="text-xs sm:text-sm font-semibold text-gray-800">Profesionales:</span>
                                <div className="flex flex-wrap gap-2 sm:gap-3 mt-2">
                                    {[
                                        { name: "Darío", src: "/imageBarber2.jpeg" },
                                        { name: "Maxi", src: "/imageBarber1.jpeg" },
                                        ...
                                        <div key={index} className="flex items-center gap-1.5 sm:gap-2">
                                            ...
                                            <span className="text-xs sm:text-sm text-gray-600">{pro.name}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
                ...
                <div className="border-t border-gray-200 pt-4 sm:pt-6 md:pt-8">
                    <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mb-3 sm:mb-4 md:mb-6 font-sans tracking-wide">
                        Nuestros servicios
                    </h2>
                    <SelectService />
                </div>
